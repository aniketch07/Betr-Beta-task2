...
const REAL_FIREBASE_PROJECT_ID = "task2-73bf6";
...
describe("adding an item to the cart recalculates the cart total.", function() {
  this.timeout(10000); // Increase timeout to 10 seconds for the entire suite
  ...
  it("should sum the cost of their items", async () => {
    ...
    // Set initial state of Alice's cart
    ...
    // Wait for cart to update and assert the new total
